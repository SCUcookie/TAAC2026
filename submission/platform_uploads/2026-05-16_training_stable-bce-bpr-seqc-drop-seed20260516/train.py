...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--domain_dropout_probs', type=str, default='',
                        help='Comma-separated per-domain sequence dropout probs, e.g. seq_c:0.06')
    ...
    parser.add_argument('--pairwise_bpr_weight', type=float, default=0.0,
                        help='Weight for an in-batch BPR ranking term over positive/negative logits')
...
def main() -> None:
    ...
    trainer = PCVRHyFormerRankingTrainer(
        ...
        pairwise_bpr_weight=args.pairwise_bpr_weight,
        domain_dropout_probs=args.domain_dropout_probs,
