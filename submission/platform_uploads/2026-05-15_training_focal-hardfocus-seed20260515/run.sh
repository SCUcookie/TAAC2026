...
# Focal loss is the only training-objective change versus the promoted
# 20260512 recipe. It targets hard positives/negatives without changing the
# model architecture or evaluator compatibility.
