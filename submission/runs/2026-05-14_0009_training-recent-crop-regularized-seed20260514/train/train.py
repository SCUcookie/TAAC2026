...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--train_recent_crop_prob', type=float, default=0.0,
                        help='Training-only probability of replacing each sequence domain with a recent suffix')
    parser.add_argument('--train_recent_crop_min_ratio', type=float, default=0.5,
                        help='Minimum suffix length ratio for --train_recent_crop_prob')
...
def main() -> None:
    ...
    train_loader, valid_loader, pcvr_dataset = get_pcvr_data(
        ...
        train_recent_crop_prob=args.train_recent_crop_prob,
        train_recent_crop_min_ratio=args.train_recent_crop_min_ratio,
    )
