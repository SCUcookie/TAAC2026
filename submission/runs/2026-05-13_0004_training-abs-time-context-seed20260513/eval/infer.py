...
_FALLBACK_MODEL_CFG = {
    ...
    'xdomain_dense_dim': 0,
    'time_context_dense_dim': 0,
    'use_absolute_time_context': False,
...
def _batch_to_model_input(
    ...
    return ModelInput(
        ...
        time_context_dense_feats=device_batch.get('time_context_dense_feats'),
...
def main() -> None:
    ...
    logging.info(
        "DIAG_CONFIG batch_size=%s num_workers=%s seq_max_lens=%s primary_seq_fids=%s use_xdomain=%s use_abs_time=%s use_inter_time=%s use_continuous_time=%s",
        batch_size,
        num_workers,
        seq_max_lens,
        primary_seq_fids,
        bool(train_config.get('use_xdomain_features', False)),
        bool(train_config.get('use_absolute_time_context', False)),
    ...
    test_dataset = PCVRParquetDataset(
        ...
        use_absolute_time_context=bool(train_config.get('use_absolute_time_context', False)),
        time_context_utc_offset_hours=int(train_config.get('time_context_utc_offset_hours', 8)),
